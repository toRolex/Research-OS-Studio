...
## Optional Future Validation Inputs
- Must-prove claims:
- Must-run ablations:
...
## Route Comparison
- Route A — minimal viable mechanism:
- Route B — frontier alternative (or why inapplicable):
- For each: anchor fidelity, novelty relative to closest work, complexity, resources, decisive validation, failure risk.
- Chosen route and reasons; rejected additions:

## Unresolved Questions
- Missing source / untested assumption / required user decision:
