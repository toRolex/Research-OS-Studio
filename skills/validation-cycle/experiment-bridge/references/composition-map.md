...
| 大批量或多阶段作业 | [experiment-queue](../../experiment-queue/SKILL.md)（仅当某 milestone 声明 ≥10 作业、多 seed 网格或阶段依赖时；≤5 作业留在 run-experiment 内；6–9 按并发上限、状态可见性和用户偏好决定） | 批次清单、波次状态、OOM/停滞处理、attempt 汇总 | 不引入常驻 scheduler，不自动扩预算 |
