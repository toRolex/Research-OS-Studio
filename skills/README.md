...
| Validation Cycle | `validation-cycle/` | [run-experiment](validation-cycle/run-experiment/SKILL.md)、[experiment-queue](validation-cycle/experiment-queue/SKILL.md)（均 model-invoked，用户可点名；支持 standalone / composed） |
