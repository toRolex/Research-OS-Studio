...
| Validation Cycle | `validation-cycle/` | [monitor-experiment](validation-cycle/monitor-experiment/SKILL.md)、[training-health-check](validation-cycle/training-health-check/SKILL.md)（均 model-invoked，用户可点名；支持 standalone / composed） |
