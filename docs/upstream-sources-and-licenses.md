...
`skills/idea-cycle/research-lit/` 保留 ARIS 清晰原名，属于 Idea Cycle；默认 model-invoked，支持用户点名 standalone，以及向父报告返回 Literature Landscape 的 composed 模式。
